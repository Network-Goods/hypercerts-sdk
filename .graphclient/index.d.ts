...
export type Allowlist_orderBy = 'id' | 'root' | 'claim';
...
export type ClaimToken_orderBy = 'id' | 'tokenID' | 'claim' | 'owner' | 'units';
...
export declare function getBuiltGraphSDK<TGlobalContext = any, TOperationContext = any>(globalContext?: TGlobalContext): {
    ClaimsByOwner(variables?: Exact<{
        owner?: any;
    }>, options?: TOperationContext): Promise<ClaimsByOwnerQuery>;
    RecentClaims(variables?: Exact<{
        first?: number;
    }>, options?: TOperationContext): Promise<RecentClaimsQuery>;
    ClaimById(variables: Exact<{
        id: string;
    }>, options?: TOperationContext): Promise<ClaimByIdQuery>;
    ClaimTokensByOwner(variables?: Exact<{
        owner?: any;
    }>, options?: TOperationContext): Promise<ClaimTokensByOwnerQuery>;
    ClaimTokensByClaim(variables: Exact<{
        claimId: string;
    }>, options?: TOperationContext): Promise<ClaimTokensByClaimQuery>;
};
...
export type ClaimTokensByOwnerQuery = {
    claimTokens: Array<Pick<ClaimToken, 'id' | 'owner' | 'tokenID' | 'units'>>;
};
...
export declare const ClaimsByOwnerDocument: DocumentNode<ClaimsByOwnerQuery, Exact<{
    owner?: InputMaybe<Scalars['Bytes']>;
}>>;
export declare const RecentClaimsDocument: DocumentNode<RecentClaimsQuery, Exact<{
    first?: InputMaybe<Scalars['Int']>;
}>>;
export declare const ClaimByIdDocument: DocumentNode<ClaimByIdQuery, Exact<{
    id: Scalars['ID'];
}>>;
export declare const ClaimTokensByOwnerDocument: DocumentNode<ClaimTokensByOwnerQuery, Exact<{
    owner?: InputMaybe<Scalars['Bytes']>;
}>>;
export declare const ClaimTokensByClaimDocument: DocumentNode<ClaimTokensByClaimQuery, Exact<{
    claimId: Scalars['String'];
}>>;
