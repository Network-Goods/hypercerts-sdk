...
export type Contributor_orderBy = 'id' | 'hypercerts';
...
export type HypercertFraction_orderBy = 'id' | 'owner' | 'units' | 'hypercert';
...
export type Hypercert_orderBy = 'id' | 'claimHash' | 'minter' | 'contributors' | 'impactDateFrom' | 'impactDateTo' | 'impactScopes' | 'workDateFrom' | 'workDateTo' | 'workScopes' | 'rights' | 'uri' | 'metadata' | 'totalUnits' | 'fractions' | 'lastUpdated' | 'version';
...
export type ImpactScope_orderBy = 'id' | 'text' | 'hypercerts';
...
export type Right_orderBy = 'id' | 'text' | 'hypercerts';
...
export type WorkScope_orderBy = 'id' | 'text' | 'hypercerts';
export type _Block_ = {
